...
Primary Actors: Player
Preconditions:
The player has selected an invalid construction position.
Alternative Scenario:
The alternative scenario begins after step 1 of the main scenario.
The system informs the player that an invalid position was selected.
Postconditions: None.
