...
Alternative Scenarios: Select alternative position - Invalid construction position.
...
1. The player chooses another building position.

## Use Case: Construct a drill.

ID: 6

Especializes: Construct a structure.
...
1. The player is in the catalog window.

2. The player possesses the resources required to unlock the item.

Main Scenario:

1. The use case begins when the player selects a item to unlock.

3. The system unlocks the item.
