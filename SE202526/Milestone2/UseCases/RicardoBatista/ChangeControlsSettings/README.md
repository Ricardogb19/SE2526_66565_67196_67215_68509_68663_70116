...
###  Description: 
- The player customizes input bindings and control sensitivity.
...
### Post-conditions:
- The player's control bindings and sensitivity are updated and persist between sessions.

### Alternative Flows:
- Conflict detected (binding already in use) — system warns and allows the player to confirm override or choose another input.