...
## *Command*
### Location: `core/src/mindustry/core/NetClient`


### Analysis: 
NetClient is an enum that allows to encapsulate an operation as an object, allowing it to be triggered in a decoupled manner.
