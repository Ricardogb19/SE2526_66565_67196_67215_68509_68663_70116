...
**As a** Mindustry player, **I want to** upgrade machines with efficiency levels, **so that I can** create more resources per time unit in case of drills and other resource generators, and have better defences in case of weapons.
